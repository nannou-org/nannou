//! The **Mesh** widget implementation.
...
/// The inner mesh type used by the **Mesh**.
pub type MeshType =
    WithTexCoords<WithColors<WithIndices<MeshPoints<Points>, Indices>, Colors>, TexCoords>;

/// The **Mesh** widget.
///
/// Points are described in coordinates normalised betwee -1.0 and 1.0.
///
/// The size of a **Mesh** during layout is simply the size of the parent's maximum bound.
