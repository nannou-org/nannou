...
pub use wgpu::{
    ...
    Extent3d, Face, Features, FilterMode, FragmentState, FrontFace, ImageSubresourceRange,
    IndexFormat, Instance, Label, Limits, LoadOp, Maintain, MapMode, MultisampleState, Operations,
