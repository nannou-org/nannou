...
pub use wgpu_upstream::{
    ...
    BindGroupDescriptor, BlendComponent, BindGroupEntry, BindGroupLayout, BindGroupLayoutDescriptor,
    BindGroupLayoutEntry, BindingResource, BindingType, BlendFactor, BlendOperation, BlendState,
    Buffer, BufferAddress, BufferAsyncError, BufferBindingType, ImageCopyBuffer, ImageCopyBufferBase,
    ...
    ComputePipelineDescriptor, Face, DepthBiasState, DepthStencilState, Device,
    ...
    ImageCopyTexture, ImageCopyTextureBase, ImageDataLayout, TextureDescriptor, TextureDimension,
