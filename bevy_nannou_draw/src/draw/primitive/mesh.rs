...
impl Vertexless {
    ...
    /// `Into<Vec3>` and `color` may be of any type that implements `IntoLinSrgba`.
        ...
        I: Iterator<Item = Vertex>,
    {
        ...
        Mesh::new(v_start..v_end, i_start..i_end, vertex_mode, texture_handle)
    }
...
impl draw::render::RenderPrimitive for Mesh {
    fn render_primitive(
        self,
